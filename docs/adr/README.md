...
- [ADR-0019: The grandfather cutoff moves to 1 October 2026](0019-grandfather-cutoff-moves-to-release.md) — amends ADR-0005; the archive job never ran against the original 2026-06-22 date, so it would have archived months of existing boards at once; a fixed date applies to every deployment
