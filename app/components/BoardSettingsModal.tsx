...
export function BoardSettingsModal({ onClose }: BoardSettingsModalProps) {
  const { id: boardId, votingEnabled, votingAllowed, votingScope, notesLocked, boardLocked, attributionEnabled, updateBoardSettings } = useBoard();
  ...
  useEffect(() => {
    if (clearFetcher.data) {
      updateBoardSettings({ votingEnabled: true, votingAllowed: resolvedAllowed, votingScope, notesLocked: localNotesLocked, boardLocked: localBoardLocked, attributionEnabled });
      onClose();
    }
  }, [clearFetcher.data]);
  ...
  function handleSave() {
    if (showClearWarning) {
      ...
      updateBoardSettings({ votingEnabled: localEnabled, votingAllowed: resolvedAllowed, votingScope, notesLocked: localNotesLocked, boardLocked: localBoardLocked, attributionEnabled });
      onClose();
    }
  }
