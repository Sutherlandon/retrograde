...
export default function AccountHub({ user, home = false, closeMenu }: AccountHubProps) {
  ...
  return (
    <div className="relative z-1" ref={containerRef}>
      ...
      {/* Dropdown */}
      <div
        className={`absolute right-0 mt-2 w-52 bg-white dark:bg-gray-900 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-200 origin-top-right ${open
